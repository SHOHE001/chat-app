...
test('T35_migration_v1_to_v8 旧スキーマDBがv8になり既存行が読め、再オープンも冪等に成功', async () => {
  ...
  // 「列あり・user_version=1」の中間状態 DB でも openDb が成功し version 8 になる
