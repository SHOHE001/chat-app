...
test('UI17 mobile copy and send control: native copyを妨げず明示コピーと大きい送信ボタンを備える', () => {
...
test('UI15 restricted rooms: 作成時に一般ロールを選択し限定チャンネルを識別できる', () => {
  for (const role of ['member', 'adult', 'child', 'staff']) {
